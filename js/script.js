...
function aboutMe() {
	var aboutMeArray = ['>About:', 'hey', 'i\'m adam, a designer and creative thinker, i currently work for Promark Brands and contract with Digital Alliance Media Marketing', 'My site isn\'t ready yet, my art can be found on my instagram @artbyadamriguez'];
	seperator();
...
function contactMe() {
	var contactArray = ['>Contact:', '[Instagram] @artbyadamriguez', '[Twitter](https://twitter.com/adamriguez)'];
	seperator();
